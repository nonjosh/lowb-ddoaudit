...
- **Update Game Logic Skills**: When modifying DDO game mechanics (raid timers, XP, gear/affixes, augments, sets, ransack, crafting, weapons), YOU MUST update the corresponding skill in `.github/skills/ddo-*/`. See `AGENTS.md` for the full skill index.
